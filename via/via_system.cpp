...
void ViaSystem::EndOutputHTML() {
    _out_ofstream << "</BODY>" << std::endl << std::endl << "</HTML>" << std::endl;
}
...
void ViaSystem::EndSectionHTML() {
    _out_ofstream << "    <BR/>" << std::endl << "    <BR/>" << std::endl;
}
...
void ViaSystem::PrintEndTableHTML() {
    _out_ofstream << "    </table>" << std::endl;
}
...
void ViaSystem::EndSectionVkConfig() {
    return;
}
...
void ViaSystem::PrintEndTableRowVkConfig() {
    _out_ofstream << "\n\t\t}";
}

void ViaSystem::PrintEndTableVkConfig() {
    _out_ofstream << "\n\t}";
}
