            ...
            if (DetermineJsonLibraryPath(driver_json_path.c_str(), driver_name.c_str(), full_driver_path)) {
                ...
                if (GetFileVersion(full_driver_path, version_string)) {
                    ...
                    snprintf(generic_string, 1023, "Failed to find driver %s or %s referenced by JSON %s",
                        ConvertPathFormat(root["ICD"]["library_path"].asString()).c_str(), ConvertPathFormat(full_driver_path).c_str(), ConvertPathFormat(driver_json_path).c_str());
                    PrintBeginTableRow();
                    PrintTableElement("");
                    PrintTableElement("");
                    PrintTableElement("");
                ...
                snprintf(generic_string, 1023, "Failed to find driver %s referenced by JSON %s", ConvertPathFormat(full_driver_path).c_str(),
                    ConvertPathFormat(driver_json_path).c_str());
                PrintBeginTableRow();
                PrintTableElement("");
                PrintTableElement("");
                PrintTableElement("");
